 ...
 * @description 
 */
public class ItemPolish extends ItemWithAttribute implements IWithRecipe, IWithEvent {
	...
	public void onAttributeLevel(AttributeLevelEvent event) {
		...
		switch(StarPropertyCreator.getMagnitude(event.getStack())) {
			...
			case 3:
			case 4:
				if(event.getAttribute() == EStarAttribute.MINERAL) event.setLevel(event.getLevel()+20);
			case 5:
			case 6:
				break;
		}
